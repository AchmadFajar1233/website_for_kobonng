...
const HeaderMain = ({data}) => {
  ...
  return (
    ...
    <section className='max-w-[screen] w-full h-[30rem] lg:h-[35rem] relative'>
      ...
      <div className='w-full h-full absolute top-0 bottom-0 bg-black/60 flex flex-col justify-center items-center lg:items-start px-28'>
        <div className='text-center lg:text-left'>
          <h2><i className='text-2xl text-slate-200 font-semibold lg:text-5xl'>"Menanamkan Ilmu, Membimbing Iman,<br></br>dan Mengukir Masa Depan."</i></h2>
        ...
        <a href='#' className='text-hijauGelap font-bold rounded-md bg-krem mt-6 px-8 py-3 cursor-pointer uppercase hover:bg-hijauGelap hover:text-krem transition-colors duration-200 ease-out lg:text-xl'>Info Pendaftaran?</a>
      </div>
    </section>
    <section className='w-full my-[10rem] px-10 min-h-[25rem]'>
